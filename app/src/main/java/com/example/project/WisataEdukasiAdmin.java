...
public class WisataEdukasiAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wisata_edukasi_admin);
        listView = findViewById(R.id.itemsList);
        FAB = findViewById(R.id.tambahData);
        getSupportActionBar().setTitle("Wisata Edukasi Kalsel");

//        menginsiasi database Firebase
        database = FirebaseDatabase.getInstance().getReference();
        populateDataWisataEdukasi();
        FAB.setOnClickListener(v -> {
            Intent intent = new Intent(WisataEdukasiAdmin.this, inputFormWE.class);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.detail:
                Intent intent = new Intent(WisataEdukasiAdmin.this, DeskripsiWisataEdukasi.class);
                intent.putExtra("key", wisataEdukasi.getkey());
                startActivity(intent);
                return true;
            case R.id.edit:
                Intent intentUpdate = new Intent(WisataEdukasiAdmin.this, inputFormWE.class);
                intentUpdate.putExtra("key", wisataEdukasi.getkey());
                startActivity(intentUpdate);
                return true;
            case R.id.hapus:
                showConfirmationDialog(wisataEdukasi.getkey());
                populateDataWisataEdukasi();
                deleteImageFromStorage(wisataEdukasi.image);
                return true;
            default:
        ...
        builder.setTitle("Konfirmasi")
                ...
                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        database.child("Wisata Edukasi").child(key).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void unused) {
                                Toast.makeText(WisataEdukasiAdmin.this, "Data dihapus!", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                })
    ...
    private void deleteImageFromStorage(String imageName) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                Toast.makeText(WisataEdukasiAdmin.this, "Gambar dihapus dari storage", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                // Gagal menghapus gambar dari storage
                Toast.makeText(WisataEdukasiAdmin.this, "Gagal menghapus gambar dari storage", Toast.LENGTH_SHORT).show();
            }
        });
    }
}